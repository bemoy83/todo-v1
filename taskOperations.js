// taskOperationsNew.js - Refactored to use the store (FIXED)
...
class TaskOperationsClass {
  async create(title) {
    ...
    const newState = store.dispatch(Actions.task.create(title));
  ...
  async delete(taskId) {
    ...
    store.dispatch(Actions.task.delete(taskId));
    return true;
  }
  ...
  async update(taskId, changes) {
    ...
    store.dispatch(Actions.task.update(taskId, changes));
  ...
  async move(fromIndex, toIndex) {
    ...
    store.dispatch(Actions.task.move(fromIndex, toIndex));
    return true;
  }
  ...
  async toggleCompletion(taskId) {
    ...
    store.dispatch(Actions.task.toggleCompletion(taskId));
    return true;
  }
}
...
class SubtaskOperationsClass {
  async create(taskId, text) {
    ...
    store.dispatch(Actions.subtask.create(taskId, text));
  ...
  async delete(taskId, subtaskId) {
    ...
    store.dispatch(Actions.subtask.delete(taskId, subtaskId));
    return true;
  }
  ...
  async update(taskId, subtaskId, changes) {
    ...
    store.dispatch(Actions.subtask.update(taskId, subtaskId, changes));
  ...
  async toggle(taskId, subtaskId) {
    ...
    store.dispatch(Actions.subtask.toggle(taskId, subtaskId));
    return true;
  }
  ...
  async move(fromTaskId, subtaskId, toTaskId, toIndex) {
    ...
    store.dispatch(Actions.subtask.move(fromTaskId, subtaskId, toTaskId, toIndex));
    return true;
  }
}
...
export const TaskOperations = {
  ...
  bulk: {
    ...
    async import(data) {
      try {
        store.dispatch(Actions.bulk.import(data));
        return true;
      } catch (error) {
